...
public class DataCollector implements SensorEventListener {
    ...
    public DataCollector(Context context, LineChart mLineChart) {
        int sp = 10000;
